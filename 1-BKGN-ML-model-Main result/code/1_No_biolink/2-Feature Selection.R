...
#----2. Prepare FUNCTION for execute Benchmarking and feature selection for each Omic Group-------
Feat.Select = function(OmicGrp, VarsX){
...
# #execute
# Feat.Select(Omics[[1]],Xlist[[1]])
purrr::map2(Omics,Xlist, Feat.Select)


#save rData
save.image(str_c(outpath, "/eSet_Feature_Select.RData"))
